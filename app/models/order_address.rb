class OrderAddress
  ...
  def save
    ...
    Address.create(address_number: address_number, area_id: area_id, city: city, house_number: house_number, house_name: house_name, phone_number: phone_number,order_id: order.id)
  end
end  